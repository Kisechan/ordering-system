...
(1,'宫保鸡丁',28.00,'川菜','/img/coke.png','经典川菜，微辣香脆'),
(2,'白切鸡',32.00,'粤菜','/img/coke.png','肉质鲜嫩，清淡爽口'),
(3,'鱼香肉丝',32.00,'川菜','/img/coke.png','酸甜微辣，下饭神器'),
(4,'麻婆豆腐',18.00,'川菜','/img/coke.png','麻辣鲜香，豆腐嫩滑'),
(5,'回锅肉',36.00,'川菜','/img/coke.png','肥而不腻，蒜苗香'),
(6,'糖醋里脊',30.00,'鲁菜','/img/coke.png','酸甜酥脆，老少皆宜'),
(7,'红烧肉',38.00,'本帮','/img/coke.png','肥瘦相间，入口即化'),
(8,'清蒸鲈鱼',48.00,'粤菜','/img/coke.png','鲜嫩清爽，葱姜提鲜');
